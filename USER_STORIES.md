...
**US-029** — As a user, I want to switch the site between light and dark
color themes and have my choice remembered, so that I can read comfortably
in low light and according to my own preference without re-selecting it
every visit.
